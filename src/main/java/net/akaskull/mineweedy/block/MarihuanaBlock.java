...
package net.akaskull.mineweedy.block;
...
public class MarihuanaBlock extends MineweedyModElements.ModElement {
	@ObjectHolder("mineweedy:marihuana")
	public static final Block block = null;
	public MarihuanaBlock(MineweedyModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new TallBlockItem(block, new Item.Properties().group(MineWeedyItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("marihuana"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mineweedy:marihuana"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN_TERRACOTTA).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("marihuana");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Plantote"));
		}
