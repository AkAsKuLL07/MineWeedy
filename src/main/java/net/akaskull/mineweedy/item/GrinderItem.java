...
public class GrinderItem extends MineweedyModElements.ModElement {
	@ObjectHolder("mineweedy:grinder")
	public static final Item block = null;
	public GrinderItem(MineweedyModElements instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Pa grindar la weed"));
			}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(MineWeedyItemGroup.tab).maxDamage(500));
		}
